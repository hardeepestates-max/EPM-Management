...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head>
        <meta name="google-site-verification" content="GCS4gZbKd-e4pDwtlPTP21nX1jmYnv62AECfPzCRfmM" />
        <script
      ...
      >
        {/* Google Analytics */}
        <Script
          src="https://www.googletagmanager.com/gtag/js?id=G-61P3XLCFGZ"
