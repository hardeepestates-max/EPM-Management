...
export default function TenantTicketDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="p-6">
      <Link href="/dashboard/tenant/tickets" className="flex items-center text-slate-600 hover:text-slate-900 mb-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              {ticket.messages.length === 0 ? (
                <p className="text-slate-500 text-center py-4">No messages yet. Property management will respond shortly.</p>
              ) : (
